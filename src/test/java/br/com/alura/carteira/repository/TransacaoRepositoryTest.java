...
class TransacaoRepositoryTest {
	...
	void deveriaRetornarRelatorioDeCarteiraDeInvestimentos() {
		Usuario usuario = new Usuario("Teste","teste@email.com","123456");
		em.persist(usuario);
		...
		List<ItemCarteiraOutputDto> relatorio = repository.relatorioCarteiraDeInvestimentos();
		Assertions
		.assertThat(relatorio)
		.hasSize(4)
		.extracting(ItemCarteiraOutputDto::getTicker, ItemCarteiraOutputDto::getQuantidade, ItemCarteiraOutputDto::getPercentual)
